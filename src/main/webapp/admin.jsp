...
<head>
    ...
    <style>
        ...
        /* Quick Pay Section inside Sidebar */
        .quick-pay {
            padding: 15px;
        ...
        .quick-pay h4 { margin: 0 0 10px; font-size: 11px; color: #fbc02d; text-transform: uppercase; letter-spacing: 1px; }
        .quick-pay input { width: 100%; padding: 8px; margin-bottom: 8px; border-radius: 5px; border: none; font-size: 12px; box-sizing: border-box; background: rgba(255,255,255,0.9); }
        .pay-link-btn { background: #25d366; color: white; width: 100%; border: none; padding: 10px; border-radius: 5px; font-weight: bold; cursor: pointer; font-size: 12px; transition: 0.3s; }
        .pay-link-btn:hover { background: #128c7e; }
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <a href="#" class="menu-item active"><i class="fas fa-user-graduate"></i> Student Admission</a>
            <a href="#" class="menu-item"><i class="fas fa-tasks"></i> Assignments</a>
            <a href="#" class="menu-item"><i class="fas fa-video"></i> Live Classes</a>
            <a href="#" class="menu-item"><i class="fas fa-play-circle"></i> Recordings</a>
            <a href="#" class="menu-item"><i class="fas fa-trophy"></i> Placements</a>
            <a href="#" class="menu-item" onclick="document.getElementById('registerModal').style.display='block'">
            ...
            <!-- Quick Pay Section inside Sidebar -->
            <div class="quick-pay">
                <h4><i class="fas fa-bolt"></i> Send Payment Link</h4>
                <input type="text" id="quick-phone" placeholder="Phone Number">
                <input type="number" id="quick-amount" placeholder="Amount (₹)" value="35000">
                <button class="pay-link-btn" onclick="sendQuickLink()">
                    <i class="fab fa-whatsapp"></i> Send UPI Link
                </button>
            </div>
        </div>

        <div class="sidebar-footer">
            <a href="https://wa.me/919900508043" target="_blank" class="footer-btn support-btn">
        ...
        <div class="content-card">
            <div class="header">
                ...
                <div class="stats-badge">
                    Total Applicants: <span id="total-count">0</span>
                </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <form action="students" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group" style="grid-column: 1/-1;"><label>Email Address</label><input type="email" name="email" required></div>
                    <div class="form-group"><label>Qualification</label><input type="text" name="qualification"></div>
                    <div class="form-group"><label>Course Amount</label><input type="number" name="total_amount" value="35000"></div>
                </div>
                <div class="modal-footer">
                    <button type="submit" style="background:#1a237e; color:white; border:none; padding:10px 20px; border-radius:5px; cursor:pointer; font-weight:bold;">Submit Details</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        function sendQuickLink() {
            ...
            if(!phone) return alert('Please enter student phone number');
        ...
        function sendDirectLink(phone, name, amount) {
            ...
            const msg = encodeURIComponent(`Hello ${name}! Kindly pay ₹${amount} for your admission at Kodewala Academy using this secure UPI link: ${upiUrl}`);
            window.open(`https://wa.me/91${phone}?text=${msg}`, '_blank');
        }
                        ...
                        html += `<tr>
                            ...
                            <td>
                                <div class="action-group">
                                    <button class="btn-icon pay-link" onclick="sendDirectLink('${s.phone}', '${s.name}', ${s.totalAmount || 35000})" title="Send UPI Payment Link"><i class="fas fa-paper-plane"></i></button>
                                    ...
                                    <form action="students" method="post" style="margin:0;" onsubmit="return confirm('Delete permanently?')">
                                        ...
                                        <button type="submit" class="btn-icon delete" title="Delete Account"><i class="fas fa-trash"></i></button>
                                    </form>
                                </div>
                            </td>
                        </tr>`;
        ...
        // 1 second refresh for instant updates
